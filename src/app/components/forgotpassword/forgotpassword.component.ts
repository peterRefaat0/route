...
export class ForgotpasswordComponent {
  ...
  forgotPassword(): void {
    let userEmail = this.forgotForm.value; //{  email:value }
  ...
  resetCode(): void {
    let resetCode = this.resetCodeForm.value; // {resetCode:223223 }
  ...
  newPassword(): void {
    let resetForm = this.resetPassword.value; // {newPassword:sdwddw};
